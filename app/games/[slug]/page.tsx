    ...
    <div>
      ...
      <div style={{ height: '440px', position: 'relative', display: 'flex', alignItems: 'center', overflow: 'hidden' }}>
        ...
        <div className="max-w-7xl mx-auto px-4 w-full relative z-10 text-center">
          ...
          <h1 className="text-white font-black" style={{ fontSize: 'clamp(32px, 6vw, 56px)', lineHeight: 1.1, textShadow: `0 0 50px ${game.accent}60` }}>
            {game.tagline}
          </h1>
      ...
      <div className="max-w-7xl mx-auto px-4 py-12 space-y-14">
        ...
        <section id="heroes" className="scroll-mt-16">
          <h2 className="section-title mb-6">Meet the Heroes</h2>
          <div className="flex gap-4 overflow-x-auto pb-2">
            {game.characters.map((hero) => (
              <div
                key={hero.name}
                className="flex-shrink-0"
                style={{ width: '220px', borderRadius: '10px', overflow: 'hidden', position: 'relative', height: '300px' }}
              >
                ...
                <div style={{ position: 'absolute', bottom: '16px', left: '16px', right: '16px' }}>
                  ...
                  <h3 className="text-white font-black text-lg leading-tight">{hero.name}</h3>
        ...
        <section id="maps" className="scroll-mt-16">
          <h2 className="section-title mb-6">Maps</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {game.maps.map((map) => (
              <div key={map.name} className="card overflow-hidden">
                ...
                <div className="p-4">
                  <h3 className="font-bold text-sm" style={{ color: 'var(--text-primary)' }}>{map.name}</h3>
        ...
        <section id="lore" className="scroll-mt-16">
          <h2 className="section-title mb-6">Lore</h2>
        ...
        <section id="news" className="scroll-mt-16">
          <div className="flex items-center justify-between mb-4">
            <h2 className="section-title mb-0">ข่าวล่าสุด</h2>
        ...
        <section id="community" className="scroll-mt-16">
          <div className="flex items-center justify-between mb-4">
            <h2 className="section-title mb-0">กระทู้ล่าสุด</h2>
              ...
              <Link key={thread.id} href={`/community/${thread.slug}`} className="forum-row px-4">
                ...
                <div className="flex items-center gap-4 flex-shrink-0">
                  <div style={{ color: 'var(--text-muted)' }} className="flex items-center gap-1 text-xs">
                    <ThumbsUp size={11} /> {thread.viewCount}
                  </div>
                  <div style={{ color: 'var(--text-muted)' }} className="flex items-center gap-1 text-xs">
