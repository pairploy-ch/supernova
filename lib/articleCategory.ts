...
> = {
  news: { label: 'NEWS', tagClass: 'tag-news', filterLabel: 'ข่าว', hex: '#1a1a1a', sectionColor: 'blue' },
  event: { label: 'EVENT', tagClass: 'tag-event', filterLabel: 'Event', hex: '#ffb400', sectionColor: 'orange' },
  gaming_gear: { label: 'GEAR', tagClass: 'tag-gaming-gear', filterLabel: 'Gaming Gear', hex: '#f5c400', sectionColor: 'green' },
  aov: { label: 'ROV', tagClass: 'tag-aov', filterLabel: 'ROV', hex: '#7442ce', sectionColor: 'purple' },
  mol: { label: 'MOL', tagClass: 'tag-mol', filterLabel: 'Mobile Legends', hex: '#9b4dca', sectionColor: 'teal' },
